...
async function abrirParamItem(key, id) {
  ...
  if (key === 'areas') {
    ...
    if (def.tieneOrden) {
      ...
      let ordenSoloLectura = true; // siempre de solo lectura -- crear y editar
      if (!item) {
...
async function verFichaEmpleado(id) {
  ...
  document.getElementById('ficha-emp-contenido').innerHTML =
    ...
    // Datos Personales
    + '<div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:10px;border-bottom:1px solid var(--borde);padding-bottom:6px">Datos Personales</div>'
    + '<div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:20px">'
    + (verDatos ? '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Fecha Nacimiento</div><div style="font-size:13px">' + (e.fecha_nacimiento ? fmtFecha(e.fecha_nacimiento) : '—') + '</div></div>' : '')
    + '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Estado Civil</div><div style="font-size:13px">' + getNombre(p.civiles, e.id_estado_civil) + '</div></div>'
    + '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Sexo</div><div style="font-size:13px">' + getNombre(p.sexos, e.id_sexo) + '</div></div>'
    + '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Nivel Educativo</div><div style="font-size:13px">' + getNombre(p.niveles, e.id_nivel_educativo) + '</div></div>'
    + (verDatos ? '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Correo</div><div style="font-size:13px">' + (e.correo||'—') + '</div></div>' : '')
    + (verDatos ? '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Teléfono Móvil</div><div style="font-size:13px">' + (e.telefono_movil||'—') + '</div></div>' : '')
    + (verDatos ? '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Teléfono Fijo</div><div style="font-size:13px">' + (e.telefono_fijo||'—') + '</div></div>' : '')
    + (verDatos ? '<div class="form-full" style="grid-column:1/-1"><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Dirección</div><div style="font-size:13px">' + (e.direccion||'—') + '</div></div>' : '')
    + '</div>'

    // Contacto Emergencia
    + (e.emergencia_nombre ? '<div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:10px;border-bottom:1px solid var(--borde);padding-bottom:6px">Contacto de Emergencia</div>'
      + '<div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:20px">'
      + '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Nombre</div><div style="font-size:13px">' + e.emergencia_nombre + '</div></div>'
      + '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Teléfono</div><div style="font-size:13px">' + (e.emergencia_telefono||'—') + '</div></div>'
      + '</div>' : '')

    // Datos Laborales
    + '<div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:10px;border-bottom:1px solid var(--borde);padding-bottom:6px">Datos Laborales</div>'
    + '<div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:20px">'
    + '<div style="grid-column:1/-1"><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Empresa</div><div style="font-size:13px;font-weight:600;color:var(--naranja)">' + (e.emisores ? e.emisores.nombre : '—') + '</div></div>'
    + '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Área</div><div style="font-size:13px">' + getNombreCodigo(p.areas, e.id_area) + '</div></div>'
    + '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Cargo</div><div style="font-size:13px">' + getNombre(p.cargos, e.id_cargo) + '</div></div>'
    + '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Nivel Jerárquico</div><div style="font-size:13px">' + (function() { var n = (p.nivelesJer||[]).find(function(x){ return x.id_jerarquicos == e.id_nivel_jerarquico; }); return n ? n.nivel_jerarquicos + (n.descripcion_jerarquicos ? ' — ' + n.descripcion_jerarquicos : '') : '—'; })() + '</div></div>'
    + '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Tipo Contrato</div><div style="font-size:13px">' + getNombre(p.contratos, e.id_tipo_contrato) + '</div></div>'
    + '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Tipo Salario</div><div style="font-size:13px">' + getNombre(p.salarios, e.id_tipo_salario) + '</div></div>'
    + '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Cálculo Salario</div><div style="font-size:13px">' + getNombre(p.calculos, e.id_calculo_salario) + '</div></div>'
    + '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Frecuencia Pago</div><div style="font-size:13px">' + getNombre(p.frecuencias, e.id_frecuencia_pago) + '</div></div>'
    + (verDatos ? '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Salario</div><div style="font-family:var(--font-mono);color:var(--naranja)">' + (e.monto_salario ? (e.moneda_calculo||'USD') + ' ' + fmtUSD(e.monto_salario) : '—') + '</div></div>' : '')
    + (verDatos ? '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Moneda Cálculo</div><div style="font-size:13px">' + (e.moneda_calculo||'—') + '</div></div>' : '')
    + (verDatos ? '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Moneda Pago</div><div style="font-size:13px">' + (e.moneda_pago||'—') + '</div></div>' : '')
    + (verDatos && e.bono_alimentacion ? '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Bono Alimentación</div><div style="font-family:var(--font-mono)">' + fmtUSD(e.bono_alimentacion) + '</div></div>' : '')
    + (verDatos && e.bono_transporte   ? '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Bono Transporte</div><div style="font-family:var(--font-mono)">' + fmtUSD(e.bono_transporte) + '</div></div>' : '')
    + (verDatos && e.bono_productividad? '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Bono Productividad</div><div style="font-family:var(--font-mono)">' + fmtUSD(e.bono_productividad) + '</div></div>' : '')
    + (verDatos && e.comision_pct      ? '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Comisión</div><div style="font-family:var(--font-mono)">' + e.comision_pct + '%</div></div>' : '')
    + '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">F. Ingreso</div><div style="font-size:13px">' + (e.fecha_ingreso ? fmtFecha(e.fecha_ingreso) : '—') + '</div></div>'
    + (e.fecha_egreso ? '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">F. Egreso</div><div style="font-size:13px">' + fmtFecha(e.fecha_egreso) + '</div></div>' : '')
    + '</div>'

    // Cuenta Nómina
    + (verDatos && e.id_institucion ? '<div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:10px;border-bottom:1px solid var(--borde);padding-bottom:6px">Cuenta Nómina</div>'
      + '<div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">'
      + '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Institución</div><div style="font-size:13px">' + getNombre(p.bancos, e.id_institucion) + '</div></div>'
      + '<div><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">Tipo Cuenta</div><div style="font-size:13px">' + (e.tipo_cuenta||'—') + '</div></div>'
      + '<div class="form-full" style="grid-column:1/-1"><div style="font-size:12px;font-weight:700;color:var(--texto);letter-spacing:0.5px;text-transform:uppercase;margin-bottom:3px">N° Cuenta</div><div style="font-size:13px;font-family:var(--font-mono)">' + (e.numero_cuenta||'—') + '</div></div>'
      + '</div>' : '');
