...
async function mostrarTablaParam(key) {
  ...
  try {
    ...
    cont.innerHTML =
      ...
      + '</div>'
      + '<div class="tabla-container" style="max-height:calc(100vh - 355px)"><table style="table-layout:fixed;width:100%"><thead><tr>' + thead + '</tr></thead><tbody>'
...
async function renderEmpleados() {
  ...
  try {
    ...
    c.innerHTML =
      ...
      + '</div></div>'
      + '<div class="tabla-container" style="max-height:calc(100vh - 355px)"><table id="emp-tabla"><thead><tr>'
