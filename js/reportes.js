...
async function repInventarioRender(cont) {
  ...
  cont.innerHTML =
    ...
    + '</div>'
    + '</div>'
    + '<div class="tabla-container" style="max-height:max(200px, calc(100vh - 420px))"><table style="width:100%;min-width:900px;border-collapse:collapse;table-layout:fixed;white-space:nowrap">'
