...
async function cbConsultarSaldos() {
  ...
  try {
    ...
    resEl.innerHTML =
      ...
      + '<div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:25.5px">'
      + '<thead><tr>'
      + '<th style="text-align:left;padding:8px;border-bottom:1px solid var(--borde);color:var(--suave);font-size:25.5px">CUENTA</th>'
      + '<th style="text-align:right;padding:8px;border-bottom:1px solid var(--borde);color:var(--suave);font-size:25.5px">SALDO INICIAL</th>'
      + '<th style="text-align:right;padding:8px;border-bottom:1px solid var(--borde);color:var(--suave);font-size:25.5px">ENTRADAS</th>'
      + '<th style="text-align:right;padding:8px;border-bottom:1px solid var(--borde);color:var(--suave);font-size:25.5px">SALIDAS</th>'
      + '<th style="text-align:right;padding:8px;border-bottom:1px solid var(--borde);color:var(--suave);font-size:25.5px">SALDO CIERRE</th>'
      + '</tr></thead><tbody>'
