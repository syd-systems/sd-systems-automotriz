  ...
  try {
    ...
    resEl.innerHTML =
      ...
      + filas.map(function(f) {
          return '<tr>'
            + '<td style="padding:8px;border-bottom:1px solid var(--borde)"><span style="color:var(--naranja);font-family:var(--font-mono);font-size:15px">'+f.codigo+'</span><br>'+f.nombre+'</td>'
